# Admin PickupPointsPage

> **Screen file:** `src/pages/admin/PickupPointsPage.tsx`  
...
Manage pickup point catalogue, location, fees, and active state.

## User Flow

1. Load points including inactive.
2. Filter points.
3. Open add/edit.
...
- [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#MapPicker|MapPicker]]
