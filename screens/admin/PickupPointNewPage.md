# Admin PickupPointNewPage

> **Screen file:** `src/pages/admin/PickupPointNewPage.tsx`  
> **Route:** `/admin/pickup-points/new`  
...
Create pickup point with address, coordinates, country, fee, and active flag.
