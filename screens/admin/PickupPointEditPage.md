# Admin PickupPointEditPage

> **Screen file:** `src/pages/admin/PickupPointEditPage.tsx`  
> **Route:** `/admin/pickup-points/:pickupPointId/edit`  
...
Edit pickup point address, coordinates, country, fee, and active flag.
...
- [[frontend/components/component-catalog#PickupPointForm|PickupPointForm]], [[frontend/components/component-catalog#MapPicker|MapPicker]]
