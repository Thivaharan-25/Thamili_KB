# Admin ProductNewPage

> **Screen file:** `src/pages/admin/ProductNewPage.tsx`  
...
Create product with image, category, sale type, price, and stock fields.

## User Flow

1. Fill shared product form.
2. Preview upload.
3. Validate fields.
4. Create product.
5. Redirect to list.
