...
> **Screen file:** `src/pages/admin/ProductsPage.tsx`  
...
Catalogue management for products, stock, price, active state, and soft delete.
...
4. Open add/edit.
5. Soft-delete referenced products.

## API Endpoints And Data

- Read/update/delete: `products`
- RPC: `admin_toggle_product_status`
...
- [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#ProductCard|ProductCard]], [[frontend/components/component-catalog#SearchInput|SearchInput]]
