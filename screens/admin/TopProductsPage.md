# Admin TopProductsPage

> **Screen file:** `src/pages/admin/TopProductsPage.tsx`  
...
Show top-selling product analytics by period and country.

## User Flow

1. Select period.
2. Fetch joined order items.
3. Aggregate results.
4. Render accessible charts/table.

## API Endpoints And Data

- Read: `order_items` joined with `orders` and `products`
- Future RPC recommended
...
- [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#StatsCard|StatsCard]]
