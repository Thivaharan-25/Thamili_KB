...
> **Screen file:** `src/pages/admin/DashboardPage.tsx`  
> **Route:** `/admin`  
...
Admin overview of orders, revenue, stock alerts, delivery workload, and recent activity.

## User Flow

1. Read dashboard metrics in parallel.
2. Render independent cards.
3. Link cards to filtered lists.

## API Endpoints And Data

- Read: `orders`, `products`, `delivery_schedule`, `notifications`
...
- [[frontend/components/component-catalog#StatsCard|StatsCard]], [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#StatusBadge|StatusBadge]]
