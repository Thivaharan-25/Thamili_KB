...
> **Screen file:** `src/pages/admin/ProductEditPage.tsx`  
...
Edit product content, image, active state, stock, and price fields.

## User Flow

1. Fetch product.
2. Populate shared form.
3. Save partial update.
4. Invalidate product queries.

## API Endpoints And Data

- Read/update: `products`
- Storage upload when replacing image
...
- [[frontend/components/component-catalog#ProductForm|ProductForm]]
