# Admin DeliveryPartnersPage

> **Screen file:** `src/pages/admin/DeliveryPartnersPage.tsx`  
...
Manage delivery partner accounts and access.

## User Flow

1. Load delivery partners.
2. Search.
3. Create new.
4. Delete or disable with confirmation.

## API Endpoints And Data

- Read: `users`
- RPC: `delete_user_by_id`
- Cleanup delivery schedules
...
- [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#StatusBadge|StatusBadge]]
