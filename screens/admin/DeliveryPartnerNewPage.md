# Admin DeliveryPartnerNewPage

> **Screen file:** `src/pages/admin/DeliveryPartnerNewPage.tsx`  
> **Route:** `/admin/delivery-partners/new`  
...
Create a delivery partner account without exposing service role secrets.

## User Flow

1. Enter details.
2. Validate.
3. Call secure server path.
4. Create public profile.

## API Endpoints And Data

- Vercel: `POST /api/create-user`
