...
> **Screen file:** `src/pages/admin/OrderDetailPage.tsx`  
...
Admin detail with status updates, delivery assignment, cancellation, and refund-aware actions.

## User Flow

1. Fetch order.
2. Update status or assignment.
3. Disable pending actions.
4. Notify customer/partner.

## API Endpoints And Data

- Read/update: `orders`
- Create/update `delivery_schedule`
- Refund API when needed
...
- [[frontend/components/component-catalog#OrderDetails|OrderDetails]], [[frontend/components/component-catalog#StatusBadge|StatusBadge]], [[frontend/components/component-catalog#FormShell|FormShell]]
