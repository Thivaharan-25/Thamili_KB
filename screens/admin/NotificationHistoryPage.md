# Admin NotificationHistoryPage

> **Screen file:** `src/pages/admin/NotificationHistoryPage.tsx`  
...
Review notification history/templates and test push actions.

## User Flow

1. Load templates/history.
2. Edit templates where allowed.
3. Send test push.
4. Show safe error details.

## API Endpoints And Data

- Read/update: `notification_templates`
- Read `notifications`
- Server push API
...
- [[frontend/components/component-catalog#DataTable|DataTable]], [[frontend/components/component-catalog#NotificationItem|NotificationItem]]
