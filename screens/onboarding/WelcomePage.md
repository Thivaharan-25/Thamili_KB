...
> **Screen file:** `src/pages/onboarding/WelcomePage.tsx`  
> **Route:** `/welcome`  
...
Brand entry screen for first web launch.

## User Flow

1. Display brand and primary actions.
2. Respect reduced motion.
3. Route to country selection if no market is chosen.
...
- [[frontend/components/component-catalog#PageHeader|PageHeader]], [[frontend/components/component-catalog#ConsentBanner|ConsentBanner]]
