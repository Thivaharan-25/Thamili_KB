...
> **Screen file:** `src/pages/onboarding/OnboardingPage.tsx`  
> **Route:** `/onboarding`  
...
Introduce product browsing, checkout, delivery, and payments for first-time users.

## User Flow

1. Show concise onboarding steps.
2. Let user continue to home or login.
3. Persist onboarding completion.

## API Endpoints And Data

- No backend call required.
- Local persisted onboarding flag.
...
- [[frontend/components/component-catalog#PageHeader|PageHeader]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
...
- API reference: [[architecture/api-client#Local State|Local State]]
