...
> **Screen file:** `src/pages/errors/NotFoundPage.tsx`  
> **Route:** `*`  
...
Accessible 404 for unknown routes.

## User Flow

1. Router catches unmatched path.
2. Show recovery actions.
3. Log path and correlation id.
