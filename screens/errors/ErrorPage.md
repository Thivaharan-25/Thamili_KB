...
> **Screen file:** `src/pages/errors/ErrorPage.tsx`  
> **Route:** `errorElement`  
...
Global route error boundary fallback preventing blank screens.

## User Flow

1. Catch render/loader errors.
2. Show retry/home actions.
