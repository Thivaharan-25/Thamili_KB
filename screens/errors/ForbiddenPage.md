...
> **Screen file:** `src/pages/errors/ForbiddenPage.tsx`  
> **Route:** `/403`  
...
Accessible 403 when user lacks route permission.

## User Flow

1. Guard detects missing role.
2. Focus page heading.
3. Let user return to allowed dashboard or logout.

## API Endpoints And Data

- No backend call
- Auth store role/permission state
...
- [[frontend/components/component-catalog#EmptyState|EmptyState]], [[frontend/components/component-catalog#Error State|ErrorState]]
...
- Route group: [[architecture/routing#Error Routes|Error Routes]]
- API reference: [[architecture/api-client#Observability|Observability]]
