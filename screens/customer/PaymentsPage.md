...
> **Screen file:** `src/pages/customer/PaymentsPage.tsx`  
> **Route:** `/payments`  
...
Manage saved payment method metadata and default payment choice.

## User Flow

1. Fetch saved methods.
2. Add card through Stripe flow when enabled.
...
- Stripe web integration for secure card handling
...
- [[frontend/components/component-catalog#PaymentMethodList|PaymentMethodList]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
...
- API reference: [[architecture/api-client#Payment Methods|Payment Methods]]
