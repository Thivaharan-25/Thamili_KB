...
> **Screen file:** `src/pages/customer/ProfilePage.tsx`  
> **Route:** `/profile`  
...
Profile hub for account, addresses, payments, notifications, settings, and privacy actions.

## User Flow

1. Load current profile.
2. Show account summary and section links.
3. Expose data access and deletion flows.
4. Logout clears sensitive state.

## API Endpoints And Data

- Read: `users` by auth id
- RPC: `delete_user_account` from deletion flow
