...
> **Screen file:** `src/pages/customer/HomePage.tsx`  
> **Route:** `/`  
...
Customer landing page with product discovery, promotions, categories, and quick cart entry.

## User Flow

1. Load active products for selected country.
2. Show featured, trending, and recently viewed sections.
3. Allow category and search navigation.
4. Guest users can browse.
5. order actions require auth.
6. During outage, cached product data remains read-only.

## API Endpoints And Data

- Read: `products` active and not deleted
- Local: recently viewed and search history
...
- [[frontend/components/component-catalog#ProductCard|ProductCard]], [[frontend/components/component-catalog#SearchInput|SearchInput]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
...
- API reference: [[architecture/api-client#Products|Products]]
