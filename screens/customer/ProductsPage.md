...
> **Screen file:** `src/pages/customer/ProductsPage.tsx`  
> **Route:** `/products`  
...
1. User searches and filters products.
2. Products render in responsive grid.
3. Out-of-stock state disables add action.
4. Add-to-cart updates existing line item idempotently.

## API Endpoints And Data

- Read: `products` with search/category filters
- Store: cart add/update
...
- [[frontend/components/component-catalog#ProductCard|ProductCard]], [[frontend/components/component-catalog#SearchInput|SearchInput]], [[frontend/components/component-catalog#QuantitySelector|QuantitySelector]]
