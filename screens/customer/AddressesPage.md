...
> **Screen file:** `src/pages/customer/AddressesPage.tsx`  
> **Route:** `/addresses`  
...
2. Add or edit address with shared form.
3. Set one default address.
...
- [[frontend/components/component-catalog#AddressForm|AddressForm]], [[frontend/components/component-catalog#MapPicker|MapPicker]], [[frontend/components/component-catalog#DataTable|DataTable]]
...
- API reference: [[architecture/api-client#Addresses|Addresses]]
