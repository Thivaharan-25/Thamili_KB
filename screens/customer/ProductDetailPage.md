...
> **Screen file:** `src/pages/customer/ProductDetailPage.tsx`  
...
Detailed product view with image, stock, country-aware price, quantity, and add-to-cart.

## User Flow

1. Fetch product by id.
2. Reserve image space for CLS.
3. Show stock and price for selected country.
4. User chooses quantity and adds to cart.
5. Related products lazy-load after primary content.

## API Endpoints And Data

- Read: `products` by id
- Store: cart and recently viewed
...
- [[frontend/components/component-catalog#ProductCard|ProductCard]], [[frontend/components/component-catalog#QuantitySelector|QuantitySelector]], [[frontend/components/component-catalog#StatusBadge|StatusBadge]]
