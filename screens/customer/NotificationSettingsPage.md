...
> **Screen file:** `src/pages/customer/NotificationSettingsPage.tsx`  
...
Manage notification channel and category preferences.

## User Flow

1. Load preferences or defaults.
2. User toggles categories/channels.
3. Save through upsert.
4. Announce save status in live region.

## API Endpoints And Data

- Read/upsert: `notification_preferences`
