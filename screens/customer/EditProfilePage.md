...
> **Screen file:** `src/pages/customer/EditProfilePage.tsx`  
> **Route:** `/profile/edit`  
...
Edit customer name, phone, avatar, and country preference.
...
2. User edits fields.
3. Validate and save.
4. Update auth/profile state after success.

## API Endpoints And Data

- Update: `users` by id
- Optional storage upload for avatar
