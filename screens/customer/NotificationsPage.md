...
> **Screen file:** `src/pages/customer/NotificationsPage.tsx`  
> **Route:** `/notifications`  
...
Notification inbox for order, delivery, payment, promotion, and system messages.

## User Flow

1. Fetch notifications newest first.
2. Show unread state in nav.
3. Mark as read when opened.
4. Deep link to related order when present.
...
- [[frontend/components/component-catalog#NotificationItem|NotificationItem]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
...
- API reference: [[architecture/api-client#Notifications|Notifications]]
