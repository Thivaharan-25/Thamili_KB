...
> **Screen file:** `src/pages/customer/SettingsPage.tsx`  
> **Route:** `/settings`  
...
Customer preferences for theme, language, consent, privacy, and account security.

## User Flow

1. Show grouped settings.
2. Theme toggle updates CSS variables.
3. Language updates i18n.
4. Privacy actions link to access/deletion flow.

## API Endpoints And Data

- Local: theme/language
- Update: user preferences when persisted
...
- API reference: [[architecture/api-client#Settings|Settings]]
