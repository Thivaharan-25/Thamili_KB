...
> **Screen file:** `src/pages/customer/OrdersPage.tsx`  
> **Route:** `/orders`  
...
Customer order history and live tracking entry.

## User Flow

1. Fetch current user orders.
2. Render newest first with status filters.
3. Realtime updates invalidate order queries.
4. Open selected order detail.

## API Endpoints And Data

- Read: `orders` by `user_id`
- Read: joined `order_items`, `pickup_points`
- Realtime: `orders`
...
- [[frontend/components/component-catalog#OrderCard|OrderCard]], [[frontend/components/component-catalog#StatusBadge|StatusBadge]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
