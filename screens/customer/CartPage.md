...
> **Screen file:** `src/pages/customer/CartPage.tsx`  
> **Route:** `/cart`  
...
Review cart items, quantities, totals, and proceed to checkout.

## User Flow

1. Hydrate cart from Zustand persistence.
2. Refresh product price and stock.
3. Warn and adjust for unavailable stock.
4. Allow quantity updates, remove, save for later.
5. Checkout requires authentication.

## API Endpoints And Data

- Read: `products` for cart item ids
- Utilities: cart totals and stock validation
...
- [[frontend/components/component-catalog#QuantitySelector|QuantitySelector]], [[frontend/components/component-catalog#ProductCard|ProductCard]], [[frontend/components/component-catalog#EmptyState|EmptyState]]
