...
> **Screen file:** `src/pages/customer/OrderConfirmationPage.tsx`  
...
Confirm successful order creation and guide next steps.

## User Flow

1. Load created order by id.
2. Show order status, total, delivery method, and next step.
3. Link to order detail and products.
4. If fetch fails, show success-safe fallback and retry.

## API Endpoints And Data

- Read: `orders` by id
- Read: joined `order_items`
